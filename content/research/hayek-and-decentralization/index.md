...
short_version: |
  Hayek's central argument is that the knowledge a society needs to run itself is **dispersed**: much of what matters is local, changing, and lost when it is compressed into the aggregate statistics a central planner works from. Prices help people coordinate without anyone first pooling all that knowledge centrally. Acemoglu — a left liberal — invokes Hayek to argue that **large language models have a centralizing architecture**, gathering all knowledge into one model, and that this cuts against the decentralization free societies require.
asked: "How does this relate to Hayek"
transcript_anchor: "a17"
models: ["Claude"]
draft: false
---
...
["The Use of Knowledge in Society"](https://www.econlib.org/library/Essays/hykKnw.html) (*AER*, 1945) — one of the most cited papers in economics, and short.
...
- The relevant knowledge is *"knowledge of the particular circumstances of time and place"* — this machine's quirks, this customer's reliability, this shortage next week.
- Much of it is **tacit**: known in practice, not statable in a form that could be transmitted to a center.
- It **changes continuously**, so an aggregate snapshot is out of date and drops the particulars that the decisions actually turn on.
- Therefore the planner's problem is not only computational scale. **Much of the relevant knowledge never reaches the center in usable form** — it is dispersed, changing, and lost in statistical aggregation. (The argument is in [sections IV–V](https://www.econlib.org/library/Essays/hykKnw.html) of the 1945 essay.)

The price system addresses this without anyone solving it: a rise in the price of tin tells everyone who uses tin to economize, and none of them needs to know why. Prices are a compression of knowledge nobody possesses in full — which is a claim about coordinating on dispersed knowledge, not by itself a proof that the resulting allocation is efficient.
...
If LLMs actually do capture dispersed tacit knowledge and hand it back to everyone cheaply, they are Hayekian *instruments*, not Hayekian *violations* — a better price system, not a planner. Either way the extension of Hayek to LLMs is an argued analogy, not an impossibility result carried over from the 1945 essay. That is the strongest form of Cowen's position and Acemoglu doesn't dispose of it. He falls back on market structure and valuations rather than on the epistemics.
...
## Reading
- Hayek, ["The Use of Knowledge in Society"](https://www.econlib.org/library/Essays/hykKnw.html) (1945) — ~15 pages, read it
- Hayek, *The Road to Serfdom* (1944) — the popular argument
- Lange & Lerner, the market-socialist position Hayek was answering
- Acemoglu & Robinson, *The Narrow Corridor* (2019) — his own account of why concentrated power threatens liberty, from the previous *Conversations with Tyler* appearance
